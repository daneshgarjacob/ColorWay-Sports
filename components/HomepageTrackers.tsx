...
const trackers = [
  {
    ...
    dek: "Every kit pairing of the tournament graded, from the opener through the July 19 Final at MetLife. England's white vs Croatia's blue is the newest perfect 10, joining three others up top with Portugal's red vs Congo DR's blue and Norway's red at 9.5. Through 26 matches the average is 8.0/10. Every matchup graded.",
