...
const trackers = [
  {
    ...
    dek: "Thunder beat Spurs in WCF Game 2 to tie 1-1. Knicks beat Cavs in ECF Game 2 at MSG to lead 2-0. Every matchup graded.",
  ...
  },
  {
    ...
    dek: "Knights take WCF Game 1 in Denver to lead Avalanche 1-0. Canadiens steal ECF Game 1 in Carolina to lead Hurricanes 1-0. Every sweater matchup graded.",
    status: "Live · Conference Finals",
    grade: "B+",
