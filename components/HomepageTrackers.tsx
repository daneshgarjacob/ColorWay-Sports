...
const trackers: TrackerCard[] = [
  {
    ...
    dek: "Every kit pairing of the tournament graded, from the opener through the July 19 Final at MetLife. Six perfect 10s now lead the board — Uruguay's Celeste vs Cape Verde's red is the newest — with Argentina's stripes vs Austria's red, Portugal's red vs Congo DR's blue, and Ecuador's yellow vs Curaçao's blue all at 9.5. Through 45 matches the average is 7.9/10. Every matchup graded.",
