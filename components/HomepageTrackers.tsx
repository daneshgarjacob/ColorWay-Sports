...
const trackers = [
  {
    ...
    dek: "Knicks sweep Cavs 4-0 to advance to the NBA Finals. Spurs even WCF at 2-2 with Game 5 in OKC tomorrow night. Every uniform matchup graded.",
  ...
  },
  {
    ...
    dek: "Knights lead Avalanche 3-0 in the WCF after Game 3 win at T-Mobile Arena. Hurricanes steal ECF Game 3 at Bell Centre in the Habs red home debut to lead Canadiens 2-1. Every sweater matchup graded.",
    status: "Live · Conference Finals",
    grade: "B+",
