...
const trackers = [
  {
    ...
    dek: "Every kit pairing of the tournament graded, from the opener through the July 19 Final at MetLife. Portugal's red vs Congo DR's blue is the latest standout at 9.5, alongside Norway's red home and three perfect 10s up top. Through 21 matches the average is 8.0/10. Every matchup graded.",
