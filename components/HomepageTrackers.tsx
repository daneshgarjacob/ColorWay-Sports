...
const trackers: TrackerCard[] = [
  {
    ...
    dek: "Every kit pairing of the tournament graded, from the opener through the July 19 Final at MetLife. Nine perfect 10s now lead the board — Norway's red vs France's mint is the newest — with Portugal's red vs Congo DR's blue, Ecuador's yellow vs Germany's navy, Colombia's yellow vs Congo DR's blue, South Africa's yellow vs Korea's red, and Sweden's yellow vs Japan's blue all at 9.5. The Round of 32 is complete — Portugal's green vs Croatia's blue led the knockout round at 9.5 — and the Round of 16 is up next. Through 86 matches the average is 8.0/10. Every matchup graded.",
