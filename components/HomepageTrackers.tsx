...
const trackers: TrackerCard[] = [
  {
    ...
    dek: "Every kit pairing of the tournament graded, from the opener through the July 19 Final at MetLife. Five perfect 10s now lead the board — the Netherlands' orange vs Sweden's blue is the newest — with Portugal's red vs Congo DR's blue and Ecuador's yellow vs Curaçao's blue both at 9.5. Through 38 matches the average is 7.9/10. Every matchup graded.",
