        ...
        <div className="w-full max-w-[1140px] mx-auto px-4 sm:px-8 flex items-center justify-between h-[80px] sm:h-[100px] gap-6">
          ...
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              {/* Wordmark-only lockup (Jake, 8/31): the tagline moved out of the
                  header and lives on in the footer and About page. The footer
                  lockup is deliberately unchanged. */}
              <span className="text-[22px] sm:text-[28px] max-[359px]:text-[19px] tracking-[-0.02em] leading-none" style={{ fontFamily: "var(--font-display)", fontWeight: 800, color: "#ffffff", WebkitTextStroke: "1.5px #2f6bed", paintOrder: "stroke fill", whiteSpace: "nowrap" }}>
                ColorWay Sports
              </span>
            </div>
          </Link>
