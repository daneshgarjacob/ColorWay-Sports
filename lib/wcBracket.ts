...
export const results: Record<string, Result> = {
  ...
  "r32-15": { winner: "ARG", score: "3-2 (AET)" },   // July 3 — Argentina beat Cape Verde 3-2 in extra time
  "r32-16": { winner: "COL", score: "1-0" },         // July 3 — Colombia beat Ghana 1-0
  "r16-1": { winner: "FRA", score: "1-0" },          // July 4 — France beat Paraguay 1-0
  "r16-2": { winner: "MAR", score: "3-0" },          // July 4 — Morocco beat Canada 3-0
  "r16-5": { winner: "NOR", score: "2-1" },          // July 4 — Norway beat Brazil 2-1
  "r16-6": { winner: "ENG", score: "3-2" },          // July 4 — England beat Mexico 3-2
  "r16-3": { winner: "ESP", score: "1-0" },          // July 4 — Spain beat Portugal 1-0
  "r16-4": { winner: "BEL", score: "4-1" },          // July 5 — Belgium beat USA 4-1
  "r16-7": { winner: "ARG", score: "3-2" },          // July 7 — Argentina beat Egypt 3-2
  "r16-8": { winner: "SUI", score: "0-0 (P 4-3)" },  // July 7 — Switzerland beat Colombia on penalties (4-3) after 0-0
  "qf-1": { winner: "FRA", score: "2-0" },           // July 9 — France beat Morocco 2-0
  "qf-2": { winner: "ESP", score: "2-1" },           // July 10 — Spain beat Belgium 2-1
  "qf-3": { winner: "ENG", score: "2-1" },           // July 10 — England beat Norway 2-1
