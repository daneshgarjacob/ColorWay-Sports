...
<div style="display:flex;align-items:center;gap:12px;margin:1.4em auto;padding:10px 16px;border-radius:10px;background:linear-gradient(135deg,#CC0000,#1A1A1A);max-width:260px;">
...
<img src="/images/posts/nc-state-wolfpack-warriors-army-uniform-2026/wolfpack-warriors-front.jpg" alt="NC State Wolfpack Warriors uniform, a dark camouflage jersey and pants with red NC STATE lettering, large red numbers outlined in white, and a black helmet with a red facemask" style="width:100%;display:block;margin:1.4em auto;border-radius:12px;border:1px solid #ececec;" />
...
B+. The restrained monochrome camo and the oversized white-outlined red numbers are the strengths. It loses ground for being a little plain, with the Army partnership showing up in the announcement more than in the uniform detailing.
