...
<div style="margin: 1.75em 0; border: 2px solid #0C2C56; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">Angels at Mariners &middot; 7:10 PM PDT</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;"><strong>54&deg;F</strong> at first pitch. T-Mobile Park stayed open all summer and started closing once September evenings dropped into the sixties.</div>
