...
<div style="margin: 1.75em 0; border: 2px solid #0C2C56; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">Cubs at Mariners &middot; 1:10 PM PT</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;"><strong>69&deg;F</strong> and dry in Seattle. This roof only moves for rain, so a dry summer afternoon means baseball in the open air.</div>
