---
title: "2026 NBA Playoff Announcers Ranked: ESPN, NBC, and Amazon Prime"
category: "NBA"
date: "2026-04-13"
updatedDate: "2026-05-11"
excerpt: "Every 2026 NBA Playoff broadcast team ranked and graded — Mike Breen, Kevin Harlan, Mike Tirico, and the full studio crews on ESPN/ABC, NBC, and Amazon Prime."
...
<div style="display: flex; flex-direction: column; gap: 8px; margin: 1.5em 0;">
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #232526 100%); border-radius: 10px; padding: 14px 20px; display: flex; justify-content: space-between; align-items: center; border-left: 4px solid #c8102e;">
<span style="color: #fff; font-weight: 700;">Game Crew</span>
<span style="background: #c8102e; color: #fff; font-size: 13px; font-weight: 800; padding: 5px 14px; border-radius: 6px;">A-</span>
</div>
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #232526 100%); border-radius: 10px; padding: 14px 20px; display: flex; justify-content: space-between; align-items: center; border-left: 4px solid #c8102e;">
...
<div style="display: flex; flex-direction: column; gap: 8px; margin: 1.5em 0;">
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #232526 100%); border-radius: 10px; padding: 14px 20px; display: flex; justify-content: space-between; align-items: center; border-left: 4px solid #6e4fcf;">
<span style="color: #fff; font-weight: 700;">Game Crew</span>
<span style="background: #6e4fcf; color: #fff; font-size: 13px; font-weight: 800; padding: 5px 14px; border-radius: 6px;">B+</span>
</div>
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #232526 100%); border-radius: 10px; padding: 14px 20px; display: flex; justify-content: space-between; align-items: center; border-left: 4px solid #6e4fcf;">
<span style="color: #fff; font-weight: 700;">Studio</span>
<span style="background: #6e4fcf; color: #fff; font-size: 13px; font-weight: 800; padding: 5px 14px; border-radius: 6px;">B-</span>
...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #232526 100%); border-radius: 12px; padding: 18px 20px; border-left: 4px solid #ffd700;">
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
<div style="display: flex; align-items: center; gap: 12px;">
<div style="background: #ffd700; color: #000; font-size: 16px; font-weight: 900; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">1</div>
<span style="color: #fff; font-size: 18px; font-weight: 700;">ESPN / ABC</span>
</div>
<span style="background: #c8102e; color: #fff; font-size: 14px; font-weight: 800; padding: 6px 16px; border-radius: 6px;">A-</span>
</div>
<div style="color: #aaa; font-size: 13px; line-height: 1.6;">Game Crew: A- &nbsp;&bull;&nbsp; Studio: A &nbsp;&bull;&nbsp; Mike Breen, Richard Jefferson, Tim Legler, Lisa Salters &nbsp;&bull;&nbsp; Inside the NBA (Shaq, Ernie, Kenny, Chuck)</div>
</div>

<div style="background: linear-gradient(135deg, #1a1a2e 0%, #232526 100%); border-radius: 12px; padding: 18px 20px; border-left: 4px solid #c0c0c0;">
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
<div style="display: flex; align-items: center; gap: 12px;">
<div style="background: #c0c0c0; color: #000; font-size: 16px; font-weight: 900; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">2</div>
<span style="color: #fff; font-size: 18px; font-weight: 700;">NBC / Peacock</span>
</div>
<span style="background: #6e4fcf; color: #fff; font-size: 14px; font-weight: 800; padding: 6px 16px; border-radius: 6px;">B</span>
</div>
<div style="color: #aaa; font-size: 13px; line-height: 1.6;">Game Crew: B+ &nbsp;&bull;&nbsp; Studio: B- &nbsp;&bull;&nbsp; Mike Tirico, Grant Hill, Noah Eagle, Reggie Miller &nbsp;&bull;&nbsp; Maria Taylor, T-Mac, Melo, Vince Carter</div>
</div>

<div style="background: linear-gradient(135deg, #1a1a2e 0%, #232526 100%); border-radius: 12px; padding: 18px 20px; border-left: 4px solid #cd7f32;">
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
<div style="display: flex; align-items: center; gap: 12px;">
