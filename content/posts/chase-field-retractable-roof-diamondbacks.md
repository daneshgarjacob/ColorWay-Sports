...
<div style="margin: 1.75em 0; border: 2px solid #A71930; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">The Diamondbacks host the Dodgers tonight, and the roof is expected to be closed.</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;">About 108 degrees at first pitch in Phoenix. Chase Field opens in mild spring weather, but nothing close to that is happening in August.</div>
