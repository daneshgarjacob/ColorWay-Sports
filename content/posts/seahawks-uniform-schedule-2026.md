...
<div style="width: 44px; height: 44px; border-radius: 10px; background: #dcefd0; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#002244" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z"/></svg></div>
<div style="flex: 1 1 160px; min-width: 0;"><div style="color: #14223f; font-size: 15px; font-weight: 700; line-height: 1.3;">Shop Seahawks Jerseys</div><div style="color: #6b7180; font-size: 13px; line-height: 1.4;">College navy, white, and the royal blue throwback, from Fanatics</div></div>
<a href="https://fanatics.93n6tx.net/5kZn3j?u=https%3A%2F%2Fwww.fanatics.com%2Fsearch%3Fquery%3Dseattle%2520seahawks%2520jersey" target="_blank" rel="sponsored noopener" data-fanatics-jersey-cta style="background: #002244; color: #ffffff; font-size: 14px; font-weight: 700; padding: 10px 18px; border-radius: 8px; text-decoration: none; white-space: nowrap; margin-left: auto;">Shop now →</a>
</div>
...
Three of Seattle's nine home dates come with a jersey named by the team, and every one of them is a standalone national window.
...
## The Full 2026 Seahawks Uniform Schedule, Week by Week
...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(138px, 1fr)); gap: 10px; margin: 1.5em 0;">
  ...
  <div style="background: #1d1d1d; color: #69BE28; border: 2px solid #69BE28; border-radius: 10px; padding: 12px 10px; text-align: center;"><div style="font-size: 0.68em; font-weight: 700; letter-spacing: 1px; opacity: 0.85;">WEEK 16</div><div style="font-size: 0.95em; font-weight: 800; margin: 4px 0; color: #ffffff;">vs Rams</div><div style="font-size: 0.76em; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px;">★ Rivalries</div></div>
...
<a href="https://fanatics.93n6tx.net/5kZn3j?u=https%3A%2F%2Fwww.fanatics.com%2Fsearch%3Fquery%3Dseattle%2520seahawks%2520throwback%2520jersey" target="_blank" rel="sponsored noopener" data-fanatics-jersey-cta style="display: inline-block; margin: 0.5em 0 0.25em; background: #2f6bed; color: #ffffff; font-size: 13px; font-weight: 700; padding: 8px 16px; border-radius: 8px; text-decoration: none;">Shop the Seahawks throwback on Fanatics →</a>

## Rivalries on Christmas Day (Week 16 vs. Rams, Confirmed)

Seattle wears its Rivalries uniform against the Rams on Friday, December 25. Christmas Day, at home, against a division rival, in the slot the league reserves for its biggest audiences of the regular season. That is the best placement any team has given a Rivalries jersey in the program's short history.

The Seahawks came into the program with the first wave in 2025 alongside the rest of the NFC West and the AFC East, so this is the uniform's second season rather than a debut. The rule across the program is one wearing per year at a home game against a division rival, and Seattle used its single wearing on the most-watched date available to it. Compare that with the teams that spend theirs on a one o'clock afternoon game in November and the difference in staging is obvious.

**Update, August 14:** the Rams confirmed they are wearing their Rivalries uniform for this game too. Both teams announced it together, so Christmas Day is a full Rivalries-on-Rivalries matchup, Seattle's set against the Rams' all-black Midnight Mode.

<blockquote class="twitter-tweet" data-dnt="true"><a href="https://twitter.com/Seahawks/status/2088295574114390256"></a></blockquote>

<blockquote class="twitter-tweet" data-dnt="true"><a href="https://twitter.com/RamsNFL/status/2088295799931441481"></a></blockquote>

That has not happened before in the program, and it is the version of Rivalries the league presumably wanted all along. A single team in a special uniform reads as a merchandise drop. Two rivals in matching-concept uniforms on the biggest regular-season stage of the year reads as an event. Whatever you think of the jerseys individually, the staging here is the best the program has managed. See the [Rams 2026 uniform schedule](/stories/rams-uniform-schedule-2026) for their side of it.

For the background on how the waves and the rules work, see our [Rivalries program explainer](/stories/what-is-the-nfl-rivalries-uniform-program).

<a href="https://fanatics.93n6tx.net/5kZn3j?u=https%3A%2F%2Fwww.fanatics.com%2Fsearch%3Fquery%3Dseattle%2520seahawks%2520rivalries%2520jersey" target="_blank" rel="sponsored noopener" data-fanatics-jersey-cta style="display: inline-block; margin: 0.5em 0 0.25em; background: #2f6bed; color: #ffffff; font-size: 13px; font-weight: 700; padding: 8px 16px; border-radius: 8px; text-decoration: none;">Shop the Rivalries jersey on Fanatics →</a>

## The Banner Game (Week 1 vs. Patriots)

The season opens on Wednesday, September 9, which is itself unusual, and Seattle raises its Super Bowl LX championship banner before kickoff. The opponent is New England, the team the Seahawks beat to win it.

No special uniform has been announced for the night. College navy is the projection, and it is the sensible one: a banner ceremony is not the place to introduce a costume, and the navy set is what Seattle wore in the Super Bowl itself. If the team were going to add a fourth uniform game, this would be the obvious candidate, and it has not.

## College Navy at Home (The Base Set, Expected)

The navy home jersey projects to the six home dates not claimed by a confirmed uniform: the Patriots in Week 1, the Chargers in Week 4, the 49ers in Week 5, the Bears in Week 8, the Cardinals in Week 9, and the Giants in Week 14. Week 4 is worth a note, because the Chargers arrive in the [navy Super Chargers set](/stories/chargers-uniform-schedule-2026) only if Seattle goes white, which the projection says it will not.

College navy with the action green numerals is a good uniform that has been slightly undermined by how much better the throwback is. The green is the part that works, an aggressive accent nobody else in the league runs, and the wolf grey pants give the combination somewhere to breathe. The all-navy monochrome version is the one we would retire.

<a href="https://fanatics.93n6tx.net/5kZn3j?u=https%3A%2F%2Fwww.fanatics.com%2Fsearch%3Fquery%3Dseattle%2520seahawks%2520navy%2520jersey" target="_blank" rel="sponsored noopener" data-fanatics-jersey-cta style="display: inline-block; margin: 0.5em 0 0.25em; background: #2f6bed; color: #ffffff; font-size: 13px; font-weight: 700; padding: 8px 16px; border-radius: 8px; text-decoration: none;">Shop the college navy jersey on Fanatics →</a>
...
<a href="https://fanatics.93n6tx.net/5kZn3j?u=https%3A%2F%2Fwww.fanatics.com%2Fsearch%3Fquery%3Dseattle%2520seahawks%2520white%2520jersey" target="_blank" rel="sponsored noopener" data-fanatics-jersey-cta style="display: inline-block; margin: 0.5em 0 0.25em; background: #2f6bed; color: #ffffff; font-size: 13px; font-weight: 700; padding: 8px 16px; border-radius: 8px; text-decoration: none;">Shop the white road jersey on Fanatics →</a>
...
Once, on Christmas Day, Friday, December 25 at home against the Los Angeles Rams. Seattle entered the Rivalries program with the 2025 NFC West wave, so this is the uniform's second season.

**What do the Seahawks wear for the Super Bowl LX banner game?**
No uniform has been announced. Seattle raises the championship banner before the Week 1 opener against New England on Wednesday, September 9, and college navy is our projection rather than a confirmation.

**Do the Seahawks wear action green in 2026?**
Not on any announced date. The action green alternate remains in the closet, but the 2026 home game themes announcement does not name it for any game.
...
Nine at Lumen Field, in Weeks 1, 4, 5, 7, 8, 9, 13, 14, and 16. The bye is Week 11.
...
<div data-division-crosslinks style="margin: 2.25em 0; padding: 1.35em 1.5em; background: #f6f7f9; border: 1px solid #e3e7ec; border-radius: 12px;"><p style="font-size: 0.7em; font-weight: 800; letter-spacing: 2.2px; text-transform: uppercase; color: #5f7085; margin: 0 0 0.35em;">The rest of the NFC West</p><p style="font-size: 0.9em; color: #5f7085; margin: 0 0 0.9em; line-height: 1.5;">Every division rival's jersey calendar for 2026.</p><a href="/stories/arizona-cardinals-uniform-schedule-2026" style="display: block; padding: 9px 0; border-bottom: 1px solid #e3e7ec; color: #14284b; font-weight: 700; text-decoration: none;">Arizona Cardinals 2026 Uniform Schedule</a><a href="/stories/rams-uniform-schedule-2026" style="display: block; padding: 9px 0; border-bottom: 1px solid #e3e7ec; color: #14284b; font-weight: 700; text-decoration: none;">Los Angeles Rams 2026 Uniform Schedule</a><a href="/stories/49ers-uniform-schedule-2026" style="display: block; padding: 9px 0; border-bottom: 1px solid #e3e7ec; color: #14284b; font-weight: 700; text-decoration: none;">San Francisco 49ers 2026 Uniform Schedule</a><a href="/stories/nfl-uniform-schedule-2026" style="display: block; margin-top: 12px; padding: 11px 14px; background: #14284b; border-radius: 8px; color: #ffffff; font-weight: 800; font-size: 13.5px; text-decoration: none; text-align: center; letter-spacing: 0.3px;">All 32 teams &middot; the 2026 NFL Uniform Schedule &rarr;</a></div>
...
*Uniform games confirmed by the Seattle Seahawks 2026 home game themes announcement. Navy-home and white-road projections follow the standard home-and-away rotation and are not team confirmations. Schedule via team and league sources. ColorWay Sports is an independent design site and is not affiliated with, endorsed by, or sponsored by the Seattle Seahawks or the National Football League.*
