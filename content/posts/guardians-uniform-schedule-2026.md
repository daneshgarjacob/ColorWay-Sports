...
<div data-mlb-wearing style="margin: 1.75em 0; border: 2px solid #14284b; border-radius: 16px; overflow: hidden;"><div style="background: #14284b; padding: 9px 16px; display: flex; justify-content: space-between; align-items: center; gap: 10px; flex-wrap: wrap;"><span style="font-size: 0.7em; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; color: #ffffff;">What the Guardians Are Wearing</span><span style="font-size: 0.7em; font-weight: 700; color: rgba(255,255,255,0.9);">Wednesday, September 23, 2026</span></div><div style="padding: 1.5em; text-align: center; background: #ffffff;"><div style="font-size: 2em; font-weight: 900; color: #1a7f37; line-height: 1.1;">Navy Alternate</div><div style="font-size: 0.78em; color: #777; margin-top: 6px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;">Confirmed</div><div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">Guardians at Boston Red Sox &middot; 7:10 PM ET</div><div style="margin-top: 8px; font-size: 0.95em; color: #444; line-height: 1.55;">Confirmed for tonight's game against the Sox.</div><div data-cap="Blue Top, Red Bill 'C'" style="margin-top: 10px; font-size: 0.9em; color: #1c1c1c; font-weight: 700;">Cap: Blue Top, Red Bill 'C'</div><a href="/mlb-tracker/guardians" style="display: inline-block; margin-top: 16px; padding: 10px 22px; background: #14284b; color: #ffffff; border-radius: 999px; font-weight: 800; font-size: 0.85em; text-decoration: none;">Every jersey they have worn &rarr;</a></div></div>
...
<div style="margin: 1.5em 0 1em; border-radius: 12px; overflow: hidden; border: 1px solid #ddd;">
  ...
  <div style="display: grid; grid-template-columns: repeat(7, 1fr); text-align: center;">
    ...
    <div style="padding: 1.2em 0.3em; background: #E31937; color: #fff;">
      <div style="font-size: 1.4em; margin-bottom: 0.2em;">🔴</div>
...
<p style="font-size: 0.85em; color: #777; margin: 0 0 2.5em;">One honest caveat the grid can't show: outside the Friday City Connect habit, Cleveland doesn't run a fixed day-of-week system. The <strong>red alternate</strong> and the <strong>navy alternate</strong> can surface on any given day — red usually at home, navy usually on the road — at the manager's discretion. Treat the week above as a representative homestand, not a guarantee.</p>

The Guardians carry five uniforms in 2026, and the set itself is unchanged from 2025 — the year the closet got its real overhaul. That refresh straightened the "Guardians" script on the home whites from a slant to horizontal, added a fresh red-navy-red piping pattern across the set, swapped the red alternate's chest from a cursive script to the blockier Bridge Print lettering, replaced the wordmark on the navy alternate with a big "Diamond C," and introduced a new home cap — a red crown with a navy bill, worn only with the whites. None of it touches the rotation; it just tidied up a wardrobe that already knew what it was after the 2022 rebrand from Indians to Guardians.
...
Let's be straight about it: the Guardians are not a scheduled-rotation team the way the [Phillies](/stories/phillies-uniform-schedule-2026) and [Marlins](/stories/marlins-uniform-schedule-2026) are. Those clubs treat their closets like a published timetable; Cleveland really only has one soft anchor — **the "CLE" City Connect on Friday home games**. Everything else is feel and matchup: home whites for the rest of the homestand, road grays for most of the trip, the red alternate dropped in at home and the navy alternate on the road whenever the staff wants a darker or bolder look, with no day-of-week assignment behind either one.
...
- [Detroit Tigers 2026 Uniform Schedule](/stories/tigers-uniform-schedule-2026) — the other AL Central look and when each jersey comes out
- [Boston Red Sox 2026 Uniform Schedule](/stories/red-sox-uniform-schedule-2026) — five uniforms anchored by two City Connects
- [New York Yankees 2026 Uniform Schedule](/stories/yankees-uniform-schedule-2026) — the AL club with the simplest rotation in baseball
...
*Uniform details compiled from team and league sources. ColorWay Sports is an independent design site and is not affiliated with, endorsed by, or sponsored by the Cleveland Guardians or Major League Baseball.*
