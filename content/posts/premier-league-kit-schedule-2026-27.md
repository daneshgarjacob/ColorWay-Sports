...
<div style="background: linear-gradient(135deg, #1a1a1a 0%, #0a0a0a 100%); border-radius: 12px; padding: 20px 28px 22px; margin: 1.5em 0;">
  ...
  <p style="color: #fff; font-size: 15px; font-weight: 900; text-align: center; margin: 0 0 4px;">FOREST RED HOME &middot; VS &middot; LEEDS WHITE HOME</p>
  <p style="color: #fff; font-size: 11px; text-align: center; letter-spacing: 1.5px; text-transform: uppercase; opacity: 0.75; margin: 10px 0 0; font-weight: 700;">Final &middot; Forest 0, Leeds 1</p>
</div>

The best looking fixture of the weekend, and it did not need a single intervention from anybody. Forest's red and Leeds' all white are two of the most stripped-down kits in English football, both of them heritage looks that have barely changed in fifty years, and putting them on the same pitch produces the cleanest separation on the card without either club reaching for an alternate. What lifts it above the opener is that all white is genuinely rare in this league. Leeds are the only club who own it outright, so this is not a default pairing even though both sides are at home in their own colors. Loses the last half-step only because neither shirt gives you anything to talk about beyond the color. **A-.**
