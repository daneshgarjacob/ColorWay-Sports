...
The helmets tell a different story from the uniforms, and it is worth reading separately: six of the eight teams changed their shell, and two clubs built genuinely excellent helmets on uniforms we did not rate. We ranked [all eight Rivalries helmets on their own](/stories/nfl-rivalries-helmets-2026-ranked), where Houston finishes sixth despite owning the best facemask in the class, and Indianapolis lands fifth on a set we failed. The full sets are ranked separately in [every Rivalries uniform, all sixteen from both classes, worst to best](/stories/nfl-rivalries-uniforms-2026-ranked).
...
Each set is built to reflect the specific team and city rather than a league-wide template, so the designs lean loud, local, and personal. They are the opposite of a plain color-swap alternate.

## The One-Game Rule

Here is the part that makes them feel like an event: each participating team wears its Rivalries uniform for just one home game a year, against a division opponent. One appearance, one stage, and then it goes back in the closet until next season.

That scarcity is the entire hook. A uniform you only see once a season carries far more weight than one a team rotates through every few weeks, and it turns a single divisional Sunday into a marked date on the calendar. It also means the matchup is the statement. Saving your best alternate for a particular rival says that is the game your season is measured against.

## Who Has One

The program rolled out in phases by division. The inaugural 2025 group was the AFC East and the NFC West, which is why teams like the Bills, Jets, Patriots, Dolphins, 49ers, Seahawks, Rams, and Cardinals were the first to debut Rivalries looks.

The Miami Dolphins built one of the most talked-about sets of that first wave, the near-black "Dark Water" uniform, and in 2026 they set its date for a Week 17 home game against the Buffalo Bills. We broke down [the Dolphins Dark Water uniform and why it divides opinion](/stories/dolphins-dark-water-rivalries-bills-january-2027) separately.
...
The Rivalries program is the rare alternate concept with a real idea behind it. By tying each uniform to a single division game, Nike and the NFL turned what could have been another throwaway alternate into an annual event, and gave the sport's oldest grudge matches a look of their own. Whether a given set lands or misses, the framework is one of the smartest things in football uniforms right now.

## Frequently Asked Questions

**What is the NFL Rivalries program?**

It is a Nike initiative that gives select NFL teams a special alternate uniform designed to be worn against a division rival. Each team wears its Rivalries uniform for one home game a year.

**How often do teams wear their Rivalries uniforms?**

Once per season, in a single home game against a division opponent. The one-game limit is what makes the uniforms feel like an event.
...
It is the near-black "Dark Water" set, which Miami will wear for one game in 2026, a Week 17 home date against the Buffalo Bills on January 3.
