...
<div style="background: linear-gradient(135deg, #1a1a2e, #0077C0); border-radius: 12px; padding: 24px 32px; text-align: center; max-width: 220px; margin: 2em auto;">
<div style="font-size: 0.7em; text-transform: uppercase; letter-spacing: 0.15em; color: rgba(255,255,255,0.6); margin-bottom: 4px;">FanDuel Sports Network</div>
