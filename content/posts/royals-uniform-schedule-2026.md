...
<div data-mlb-wearing style="margin: 1.75em 0; border: 2px solid #14284b; border-radius: 16px; overflow: hidden;"><div style="background: #14284b; padding: 9px 16px; display: flex; justify-content: space-between; align-items: center; gap: 10px; flex-wrap: wrap;"><span style="font-size: 0.7em; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; color: #ffffff;">What the Royals Are Wearing</span><span style="font-size: 0.7em; font-weight: 700; color: rgba(255,255,255,0.9);">Saturday, August 29, 2026</span></div><div style="padding: 1.5em; text-align: center; background: #ffffff;"><div style="font-size: 2em; font-weight: 900; color: #14284b; line-height: 1.1;">Road Grays</div><div style="font-size: 0.78em; color: #777; margin-top: 6px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px;">Expected &middot; we confirm it the morning after</div><div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">Royals at Cleveland Guardians &middot; 4:10 PM ET</div><div style="margin-top: 8px; font-size: 0.95em; color: #444; line-height: 1.55;">Road games are the gray road set every time, regardless of the day.</div><a href="/mlb-tracker/royals" style="display: inline-block; margin-top: 16px; padding: 10px 22px; background: #14284b; color: #ffffff; border-radius: 999px; font-weight: 800; font-size: 0.85em; text-decoration: none;">Every jersey they have worn &rarr;</a></div></div>
...
<div style="margin: 1.6em 0; padding: 16px 18px; border-radius: 14px; background: linear-gradient(135deg, #004687 0%, #004687cc 100%);">
...
<div style="margin: 1.5em 0 2.5em; border-radius: 12px; overflow: hidden; border: 1px solid #ddd;">
  <div style="display: grid; grid-template-columns: repeat(7, 1fr); text-align: center; font-size: 0.75em; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; background: #004687; color: #fff;">
  ...
  <div style="display: grid; grid-template-columns: repeat(7, 1fr); text-align: center;">
    <div style="padding: 1.2em 0.3em; background: #f7f7f7; color: #333;">
      ...
      <div style="font-size: 0.65em; color: #888; margin-top: 0.3em;">Home Default</div>
    </div>
    <div style="padding: 1.2em 0.3em; background: #f7f7f7; color: #333;">
      <div style="font-size: 1.4em; margin-bottom: 0.2em;">⚾</div>
      <div style="font-weight: 800; font-size: 0.8em; line-height: 1.2;">Home White</div>
    ...
    <div style="padding: 1.2em 0.3em; background: #b1005a; color: #fff;">
      <div style="font-size: 1.4em; margin-bottom: 0.2em;">⛲</div>
      <div style="font-weight: 800; font-size: 0.8em; line-height: 1.2;">City Connect</div>
      <div style="font-size: 0.65em; color: rgba(255,255,255,0.75); margin-top: 0.3em;">Friday Home</div>
    </div>
    <div style="padding: 1.2em 0.3em; background: #7BB2DD; color: #11233b;">
      <div style="font-size: 1.4em; margin-bottom: 0.2em;">💎</div>
      <div style="font-weight: 800; font-size: 0.8em; line-height: 1.2;">Powder Blue</div>
      <div style="font-size: 0.65em; color: rgba(17,35,59,0.7); margin-top: 0.3em;">Saturday Home</div>
    </div>
    <div style="padding: 1.2em 0.3em; background: #f7f7f7; color: #333;">
      <div style="font-size: 1.4em; margin-bottom: 0.2em;">⚾</div>
      <div style="font-weight: 800; font-size: 0.8em; line-height: 1.2;">Home White</div>
...
That sample week shows a representative home stand. The two fixed points are Friday and Saturday. Outside of those, the home default is the white uniform and the road default is the gray, and the royal blue alternate floats in at the team's discretion. We will walk through all five looks and where each one fits.

## Home White (Home Default)

The home whites are the foundation of the Royals' look and the uniform you will see most often at Kauffman Stadium. The white jersey carries the script "Royals" wordmark across the chest in royal blue with gold trim, and it pairs with the blue interlocking "KC" cap. It is clean, it is classic, and it has anchored this franchise's identity for decades.
...
The Royals do not run the kind of rigid, every-day-has-a-jersey system that a few MLB teams use. Beyond the Friday and Saturday home anchors, there is no strict rotation, and we think that is a perfectly reasonable way to do it. Two clear pillars give the schedule a backbone while leaving the rest of the week loose.
...
It is the brand new "Forever Fountains" set, unveiled on April 9, 2026 and worn beginning that weekend. The jersey and pants are both white, with lettering in a fuchsia-to-blue gradient (with purple) that represents a Kansas City sunset fading into the blue of the city's 200-plus fountains, the "City of Fountains." It features a crown logo, a fuchsia-to-royal-blue gradient cap, a new heart sleeve patch, and "HEY HEY HEY HEY" inside the collar. It replaced the team's original 2022 blue City Connect, which has been retired.

**When do the Royals wear their powder blue uniform?**

The powder blue full set is the Royals' established practice, announced in 2025, for Saturday home games and Opening Day, and that practice is expected to continue in 2026. We would frame it as the team's standing routine rather than a confirmed 2026 directive, so it is the strong favorite for Saturdays at Kauffman Stadium rather than a guaranteed rule.

**When do the Royals wear their City Connect jersey?**
...
**What is the Royals' home uniform in 2026?**

The home default is the white jersey and uniform with the royal blue "Royals" script in gold trim across the chest, paired with the blue interlocking "KC" cap. It is the look you will see on most home dates that are not Friday or Saturday.

**Did the Royals change their colors for 2026?**
...
- [Kansas City Royals City Connect 2026: Forever Fountains First Look](/stories/royals-city-connect-2026-official) · a full breakdown of the new fuchsia-to-blue fountains set
- [Philadelphia Phillies 2026 Uniform Schedule](/stories/phillies-uniform-schedule-2026) · the five-jersey rotation that runs a strict day-by-day system
