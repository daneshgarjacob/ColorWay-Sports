...
<div style="margin: 0 0 1.75em;">
  <img src="/images/posts/world-cup-kit-rules/cover.jpg" alt="ColorWay Sports explainer cover titled Who Wears What at the World Cup, showing a light jersey silhouette and a red jersey silhouette separated by a contrast seam on a dark navy background, illustrating the 2026 World Cup kit-clash rules that decide which kit each team wears" style="width: 100%; display: block; border-radius: 10px;" />
</div>
...
You can watch these rules play out match by match in [our running 2026 World Cup jersey tracker](/stories/world-cup-2026-jersey-tracker). A few of the clearest examples so far:
...
<div style="margin: 2em 0; padding: 1.5em 1.75em; background: linear-gradient(135deg, #0B1A2F 0%, #11161D 100%); border-radius: 16px; border: 1px solid rgba(255,255,255,0.08);">
  <p style="margin: 0 0 0.9em; font-size: 1.05em; font-weight: 800; color: #fff;">Want the shirts themselves?</p>
  <p style="margin: 0 0 1.1em; font-size: 0.95em; color: #c8cfda; line-height: 1.6;">We grade every kit pairing of the tournament in our <a href="/stories/world-cup-2026-jersey-tracker" style="color: #FF5910; font-weight: 700; text-decoration: none;">live match-by-match jersey tracker</a>, and rank every individual home and away shirt in our <a href="/stories/every-2026-world-cup-jersey-ranked" style="color: #FF5910; font-weight: 700; text-decoration: none;">full kit rankings</a>.</p>
  <a href="https://fanatics.93n6tx.net/5kZn3j?u=https%3A%2F%2Fwww.fanatics.com%2Fsoccer-national-teams%2Fo-3690%2Bz-981768652-96597765%3Fvap%3D1" target="_blank" rel="sponsored noopener" data-fanatics-jersey-cta style="display: inline-block; padding: 10px 20px; background: linear-gradient(135deg, #C8102E 0%, #8B0000 100%); border-radius: 999px; color: #fff; font-size: 13px; font-weight: 800; text-decoration: none; letter-spacing: 1px; text-transform: uppercase; box-shadow: 0 2px 8px rgba(200,16,46,0.35);">Shop National Team Jerseys at Fanatics</a>
</div>
