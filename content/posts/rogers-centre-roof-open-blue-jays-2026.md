...
<div style="margin: 1.75em 0; border: 2px solid #134A8E; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">The Blue Jays hosted the Yankees this afternoon, and the roof was expected to be open.</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;">About 76 degrees with a 1 percent chance of rain at first pitch in Toronto. Rogers Centre closes on rain risk or cold, and today was neither.</div>
...
<div style="margin: 1.5em 0; padding: 1.75em 1.5em; background: linear-gradient(135deg, #134A8E 0%, #1D9BD7 100%); border-radius: 16px; text-align: center;">
  <p style="font-size: 0.75em; font-weight: 800; text-transform: uppercase; letter-spacing: 2.5px; margin: 0 0 0.75em; color: rgba(255,255,255,0.9);">Today's Blue Jays Home Game</p>
  <p style="font-size: 1.1em; font-weight: 700; margin: 0 0 1.25em; color: #fff; line-height: 1.4;">Jays operations make the call about 90 minutes before first pitch, based on temperature, rain, and wind.</p>
  <div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center;">
    <a href="https://x.com/BlueJays" style="padding: 10px 18px; background: #fff; color: #134A8E; border-radius: 999px; font-weight: 800; font-size: 0.9em; text-decoration: none; letter-spacing: 0.5px;">@BlueJays on X</a>
    <a href="https://isthedomeopen.com/" style="padding: 10px 18px; background: #fff; color: #134A8E; border-radius: 999px; font-weight: 800; font-size: 0.9em; text-decoration: none; letter-spacing: 0.5px;">IsTheDomeOpen.com</a>
  </div>
</div>

For today's Blue Jays home game roof status at Rogers Centre, the fastest sources are:

- **[IsTheDomeOpen.com](https://isthedomeopen.com/)** is a dedicated site that answers exactly that question for each game
- **[@BlueJays on X](https://x.com/BlueJays)** for game-day updates from the team
...
Rogers Centre is the most open retractable roof in baseball, just ahead of Milwaukee's [American Family Field](/stories/american-family-field-roof-open-brewers-2026). Both sit far above the hot-climate parks: the [Houston Astros](/stories/daikin-park-roof-open-astros-2026) at Daikin Park and the [Texas Rangers](/stories/rangers-roof-open-globe-life-field-2026) at Globe Life Field keep their roofs closed for most of the season.
...
If it is a warm, dry day from late spring into summer, expect the dome open and the Toronto skyline overhead. Cold April nights and rainy days stay closed. For any specific game, check [IsTheDomeOpen.com](https://isthedomeopen.com/) or [@BlueJays](https://x.com/BlueJays), and remember the official call lands about 90 minutes before first pitch.

## Frequently Asked Questions

**Is the Rogers Centre dome open today?**

The Blue Jays decide about 90 minutes before first pitch. They open the roof when it is above roughly 57°F, dry, and calm, which usually means warm days from late spring through summer. Cold and rain keep it closed. Check [IsTheDomeOpen.com](https://isthedomeopen.com/) or [@BlueJays](https://x.com/BlueJays) for the day's status.
...
Check [IsTheDomeOpen.com](https://isthedomeopen.com/), follow [@BlueJays](https://x.com/BlueJays) on X, or look at the Toronto forecast. The official call is made about 90 minutes before first pitch.
