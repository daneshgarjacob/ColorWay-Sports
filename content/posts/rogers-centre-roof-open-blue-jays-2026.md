...
<div style="margin: 1.75em 0; border: 2px solid #134A8E; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">Rays at Blue Jays &middot; 3:07 PM ET</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;"><strong>69&deg;F</strong> and dry at first pitch, with rain chances near zero all afternoon. This is exactly the window Toronto opens the roof in: mild, dry, and no wind worth worrying about. A getaway-day matinee in the high 60s is about as open-and-shut as it gets, but confirm before you go.</div>
