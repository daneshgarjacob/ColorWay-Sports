...
<div style="margin: 1.75em 0; border: 2px solid #134A8E; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">The Blue Jays host the Cardinals tonight, and the roof is open.</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;">Clear and around 77 degrees in Toronto, which is exactly the mild, dry evening that gets the Rogers Centre roof open. It stays closed for most of the season, so an open roof is worth showing up for.</div>
