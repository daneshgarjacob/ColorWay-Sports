...
<div style="flex: 1 1 170px; min-width: 0;"><div style="color: #14223f; font-size: 15px; font-weight: 700; line-height: 1.3;">Going to the game?</div><div style="color: #6b7180; font-size: 13px; line-height: 1.4;">Find Blue Jays home tickets on SeatGeek</div></div>
<a href="https://seatgeek.com/toronto-blue-jays-tickets" target="_blank" rel="sponsored noopener" data-ticket-cta style="background: #12925a; color: #ffffff; font-size: 14px; font-weight: 700; padding: 10px 18px; border-radius: 8px; text-decoration: none; white-space: nowrap; margin-left: auto;">Get Tickets &rarr;</a>
</div>
