---
title: "Disney+ Lands UEFA Champions League, Europa League, and Conference League Rights From Paramount"
category: "Soccer"
date: "2026-04-27"
...
<div style="margin: 2em 0; border-radius: 12px; overflow: hidden; border: 1px solid rgba(0,0,0,0.1);">
  <table style="width: 100%; border-collapse: collapse; font-size: 0.95em;">
    <thead>
      <tr style="background: linear-gradient(90deg, #003D7A 0%, #00A651 100%); color: #fff;">
        <th style="padding: 14px 16px; text-align: left; font-weight: 800;">Competition</th>
        <th style="padding: 14px 16px; text-align: left; font-weight: 800;">Country</th>
        <th style="padding: 14px 16px; text-align: left; font-weight: 800;">US Streaming Home</th>
      </tr>
    </thead>
    <tbody>
      <tr style="background: #fff;">
        <td style="padding: 12px 16px; font-weight: 700;">UEFA Champions League</td>
        <td style="padding: 12px 16px;">Europe (club)</td>
        <td style="padding: 12px 16px; font-weight: 700; color: #FF6B1A;">Disney+ (from 2026-27)</td>
      </tr>
      <tr style="background: #f7f8fa;">
        <td style="padding: 12px 16px; font-weight: 700;">UEFA Europa League</td>
        <td style="padding: 12px 16px;">Europe (club)</td>
        <td style="padding: 12px 16px; font-weight: 700; color: #FF6B1A;">Disney+ (from 2026-27)</td>
      </tr>
      <tr style="background: #fff;">
        <td style="padding: 12px 16px; font-weight: 700;">UEFA Conference League</td>
        <td style="padding: 12px 16px;">Europe (club)</td>
        <td style="padding: 12px 16px; font-weight: 700; color: #FF6B1A;">Disney+ (from 2026-27)</td>
      </tr>
      <tr style="background: #f7f8fa;">
        <td style="padding: 12px 16px; font-weight: 700;">Premier League</td>
        <td style="padding: 12px 16px;">England</td>
        <td style="padding: 12px 16px;">Peacock (NBC linear partner)</td>
      </tr>
      <tr style="background: #fff;">
        <td style="padding: 12px 16px; font-weight: 700;">La Liga</td>
        <td style="padding: 12px 16px;">Spain</td>
        <td style="padding: 12px 16px;">ESPN+</td>
      </tr>
      <tr style="background: #f7f8fa;">
        <td style="padding: 12px 16px; font-weight: 700;">Bundesliga</td>
        <td style="padding: 12px 16px;">Germany</td>
        <td style="padding: 12px 16px;">ESPN+</td>
      </tr>
      <tr style="background: #fff;">
        <td style="padding: 12px 16px; font-weight: 700;">Serie A</td>
        <td style="padding: 12px 16px;">Italy</td>
        <td style="padding: 12px 16px; font-weight: 700; color: #003D7A;">Paramount+ (staying)</td>
      </tr>
      <tr style="background: #f7f8fa;">
        <td style="padding: 12px 16px; font-weight: 700;">Ligue 1</td>
        <td style="padding: 12px 16px;">France</td>
        <td style="padding: 12px 16px;">Fubo / beIN Sports</td>
      </tr>
      <tr style="background: #fff;">
        <td style="padding: 12px 16px; font-weight: 700;">FA Cup</td>
        <td style="padding: 12px 16px;">England (cup)</td>
        <td style="padding: 12px 16px;">ESPN+</td>
      </tr>
      <tr style="background: #f7f8fa;">
        <td style="padding: 12px 16px; font-weight: 700;">Carabao Cup</td>
        <td style="padding: 12px 16px;">England (cup)</td>
        <td style="padding: 12px 16px;">Paramount+ (CBS Sports)</td>
      </tr>
      <tr style="background: #fff;">
        <td style="padding: 12px 16px; font-weight: 700;">Coppa Italia</td>
        <td style="padding: 12px 16px;">Italy (cup)</td>
        <td style="padding: 12px 16px;">Paramount+</td>
      </tr>
      <tr style="background: #f7f8fa;">
        <td style="padding: 12px 16px; font-weight: 700;">Copa del Rey</td>
        <td style="padding: 12px 16px;">Spain (cup)</td>
        <td style="padding: 12px 16px;">ESPN+</td>
      </tr>
      <tr style="background: #fff;">
        <td style="padding: 12px 16px; font-weight: 700;">Eredivisie</td>
        <td style="padding: 12px 16px;">Netherlands</td>
        <td style="padding: 12px 16px;">ESPN+</td>
      </tr>
      <tr style="background: #f7f8fa;">
        <td style="padding: 12px 16px; font-weight: 700;">MLS</td>
        <td style="padding: 12px 16px;">United States</td>
        <td style="padding: 12px 16px;">Apple TV (MLS Season Pass)</td>
      </tr>
    </tbody>
  </table>
</div>
