...
logoSrc2: "/logos/teams/nfl-cleveland-browns.png"
league: nfl
...
<div style="width: 44px; height: 44px; border-radius: 10px; background: #ffe6db; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FF3C00" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.47a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.47a2 2 0 0 0-1.34-2.23z"/></svg></div>
<div style="flex: 1 1 160px; min-width: 0;"><div style="color: #14223f; font-size: 15px; font-weight: 700; line-height: 1.3;">Shop Browns Jerseys</div><div style="color: #6b7180; font-size: 13px; line-height: 1.4;">Every Browns jersey, from Fanatics</div></div>
<a href="https://fanatics.93n6tx.net/5kZn3j?u=https%3A%2F%2Fwww.fanatics.com%2Fsearch%3Fquery%3Dcleveland%2520browns%2520jersey" target="_blank" rel="sponsored noopener" data-fanatics-jersey-cta style="background: #FF3C00; color: #ffffff; font-size: 14px; font-weight: 700; padding: 10px 18px; border-radius: 8px; text-decoration: none; white-space: nowrap; margin-left: auto;">Shop now →</a>
</div>
...
Cleveland is unusual. Most teams have one alternate; the Browns have effectively three routes out of the base uniform, and two of them are helmets rather than jerseys.

**The brown home set.** Orange helmet, brown jersey, and a choice of white or brown pants. This is the base and it is the correct one. The orange helmet is the most recognisable thing the franchise owns, largely because it is the only logo-free helmet in the league and has been for most of eighty years.

**The white road set.** Same helmet, white jersey, usually with white or brown pants.

**Alpha Dawg.** The all-brown look, built around a **brown alternate helmet** rather than the orange one. It is effectively the descendant of the 2016 Color Rush, with the helmet finally matching the rest of it, and it is the loudest thing Cleveland puts on a field.

**The white alternate helmet.** Introduced in 2023 and worn with the white jersey and orange pants. It is the quietest of the alternates and the one that looks least like the Browns, which is either the point or the problem depending on who you ask.

League rules cap alternate helmets at three games a season, and Alpha Dawg and the white shell both draw from that allowance.
...
Nothing has been announced, and there is a rules complication worth knowing about: the 1946 throwback set has already been worn the maximum number of times the league permits without a waiver. Cleveland would need the NFL to grant one for the uniform to return.

We are not going to put it on the grid. If a waiver is granted and a date is named, it goes here.
...
The all-brown look built around a brown alternate helmet instead of the standard orange one. It is the successor to the 2016 Color Rush uniform, with the helmet now matching the jersey and pants.

**Do the Browns have a white helmet?**

Yes. Cleveland introduced a white alternate helmet in 2023, worn with the white jersey and orange pants. It counts against the league's three-game alternate helmet allowance.

**Will the Browns wear their 1946 throwbacks in 2026?**

Nothing has been announced, and the set has already reached the maximum number of appearances the league allows without a waiver. Cleveland would need the NFL to grant one.
