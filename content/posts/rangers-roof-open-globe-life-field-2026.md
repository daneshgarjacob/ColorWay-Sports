...
<div style="margin: 1.75em 0; border: 2px solid #003278; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">The Rangers are on the road today (at the Rays).</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;">No home game at Globe Life Field. When Texas is home in July, the roof stays closed and air-conditioned against the Arlington heat, opening only on a rare dry day in the 65 to 80 degree window.</div>
