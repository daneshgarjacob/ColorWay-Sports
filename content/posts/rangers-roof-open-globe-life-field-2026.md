...
<div style="margin: 1.75em 0; border: 2px solid #003278; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">The Rangers are on the road today.</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;">No game at Globe Life Field. Texas keeps the roof closed through the summer heat, so expect closed on the next home date.</div>
