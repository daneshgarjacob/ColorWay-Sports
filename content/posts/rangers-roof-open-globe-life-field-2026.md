...
<div style="margin: 1.75em 0; border: 2px solid #003278; border-radius: 16px; overflow: hidden;">
  ...
  <div style="padding: 1.5em; text-align: center; background: #ffffff;">
    ...
    <div style="margin-top: 14px; font-size: 1em; color: #1c1c1c; font-weight: 600;">Nationals at Rangers &middot; 7:05 PM CT</div>
    <div style="margin-top: 6px; font-size: 0.95em; color: #444; line-height: 1.5;">First-pitch temperature near <strong>102&deg;F</strong> with no rain in the forecast. The Rangers close the roof for heat in more than 80% of home games, so expect it shut with the air conditioning running.</div>
