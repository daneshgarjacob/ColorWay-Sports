...
const CLUBS = {
  ...
  'chelsea':           { name: 'CHELSEA',        shirt: 'chelsea-home',        label: 'HOME',  grade: 'C+',  base: '#034694', mid: '#022c5e', deep: '#050d1a', accent: '#e6c565' },
  ...
  'manchester-city':   { name: 'MAN CITY',       shirt: 'man-city-home',       label: 'HOME',  grade: 'C', base: '#6CABDD', mid: '#2b6a9c', deep: '#0a2233', accent: '#f2e28a' },
  ...
  'tottenham':         { name: 'TOTTENHAM',      shirt: 'tottenham-away',      label: 'AWAY',  grade: 'C+',  base: '#101c3a', mid: '#0a1226', deep: '#000000', accent: '#c9a0ff' },
};
