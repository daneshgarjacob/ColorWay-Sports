...
const CLUBS = {
  'arsenal':           { name: 'ARSENAL',        shirt: 'arsenal-home',        label: 'HOME', base: '#EF0107', mid: '#8d0104', deep: '#041f3f', accent: '#ffd166' },
  'aston-villa':       { name: 'ASTON VILLA',    shirt: 'aston-villa-home',    label: 'HOME', base: '#670E36', mid: '#3d0820', deep: '#0d1b33', accent: '#95BFE5' },
  'bournemouth':       { name: 'BOURNEMOUTH',    shirt: 'bournemouth-home',    label: 'HOME', base: '#DA291C', mid: '#7a1710', deep: '#0a0a0a', accent: '#d8b45a' },
  'brentford':         { name: 'BRENTFORD',      shirt: 'brentford-home',      label: 'HOME', base: '#e30613', mid: '#8f0009', deep: '#0f1a3c', accent: '#f5c451' },
  'brighton':          { name: 'BRIGHTON',       shirt: 'brighton-home',       label: 'HOME', base: '#0057B8', mid: '#013a7a', deep: '#04263f', accent: '#00d6c8' },
  'chelsea':           { name: 'CHELSEA',        shirt: 'chelsea-home',        label: 'HOME',  base: '#034694', mid: '#022c5e', deep: '#050d1a', accent: '#e6c565' },
  'coventry-city':     { name: 'COVENTRY CITY',  shirt: 'coventry-home',       label: 'HOME', base: '#4a9bd4', mid: '#1d5b8a', deep: '#08243a', accent: '#f2d27a' },
  'crystal-palace':    { name: 'CRYSTAL PALACE', shirt: 'crystal-palace-away', label: 'AWAY', base: '#1B458F', mid: '#121f3d', deep: '#0a0a0a', accent: '#C4122E' },
  'everton':           { name: 'EVERTON',        shirt: 'everton-home',        label: 'HOME', base: '#003399', mid: '#00205e', deep: '#040c1f', accent: '#f2c94c' },
  'fulham':            { name: 'FULHAM',         shirt: 'fulham-home',         label: 'HOME', base: '#1f1f1f', mid: '#121212', deep: '#000000', accent: '#CC0000' },
  'hull-city':         { name: 'HULL CITY',      shirt: 'hull-home',           label: 'HOME', base: '#F5A12D', mid: '#a2650f', deep: '#0a0a0a', accent: '#ffffff' },
  'ipswich-town':      { name: 'IPSWICH TOWN',   shirt: 'ipswich-home',        label: 'HOME', base: '#0044a9', mid: '#002d6e', deep: '#0b0f1c', accent: '#e8a0b4' },
  'leeds-united':      { name: 'LEEDS UNITED',   shirt: 'leeds-home',          label: 'HOME', base: '#1D428A', mid: '#12285a', deep: '#070d1c', accent: '#FFCD00' },
  'liverpool':         { name: 'LIVERPOOL',      shirt: 'liverpool-home',      label: 'HOME', base: '#C8102E', mid: '#7a0a1c', deep: '#0d0507', accent: '#00B2A9' },
  'manchester-city':   { name: 'MAN CITY',       shirt: 'man-city-home',       label: 'HOME', base: '#6CABDD', mid: '#2b6a9c', deep: '#0a2233', accent: '#f2e28a' },
  'manchester-united': { name: 'MAN UNITED',     shirt: 'man-united-away',     label: 'AWAY', base: '#DA291C', mid: '#7a1710', deep: '#0a0a0a', accent: '#FBE122' },
  'newcastle':         { name: 'NEWCASTLE',      shirt: 'newcastle-home',      label: 'HOME', base: '#241F20', mid: '#141112', deep: '#000000', accent: '#41B6E6' },
  'nottingham-forest': { name: 'NOTT’M FOREST',  shirt: 'forest-home',         label: 'HOME', base: '#DD0000', mid: '#8a0000', deep: '#0a0a0a', accent: '#8fd6a8' },
  'sunderland':        { name: 'SUNDERLAND',     shirt: 'sunderland-home',     label: 'HOME', base: '#EB172B', mid: '#8a0d19', deep: '#141112', accent: '#f4a8b8' },
  'tottenham':         { name: 'TOTTENHAM',      shirt: 'tottenham-away',      label: 'AWAY',  base: '#101c3a', mid: '#0a1226', deep: '#000000', accent: '#c9a0ff' },
};
...
function svgFor(c, isHub) {
  const grade = ''; // wardrobe badge removed 2026-08-24 (Jake): grades live on the page, never on the cover, so covers cannot go stale on a regrade
